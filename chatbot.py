...
def book_flight():
    ...
    print("Thank you! Your flight has been booked from {0} to {1} departing on {2} and returning on {3}.".format(
...
def check_flight_availability():
    ...
    print("Great! Now, can you tell me your travel dates?")
    departure_date = input("Departure date (YYYY-MM-DD): ")
    print("Flights are available from {0} to {1} on {2}.".format(
...
def book_hotel():
    ...
    print("Thank you! Your hotel has been booked in {0} from {1} to {2}.".format(
        destination, check_in_date, checkout_date))
...
def cancel_booking():
    ...
    try:
        ...
        return
    print("Your booking with reference number {0} has been cancelled.".format(
        booking_ref))
